...
class _GarageEditPageState extends State<GarageEditPage> {
  ...
  Future<void> _updateGarage() async {
    if (_garageFormKey.currentState!.validate()) {
      ...
      if (response['success']) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Garage updated successfully".tr())),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
            ...
            children: [
              ...
              if (!isLoadingBrands)
                DropdownButtonFormField<int>(
                  ...
                  validator: (value) =>
                      value == null ? "Select Brand Expert".tr() : null,
                ),
              const SizedBox(height: 12),
              ...
              Column(
                ...
                children: [
                  Text("Select Garage Location".tr(),
              ...
              _isLoading
                  ...
                  : MyElevatedButton(
                      onPressed: _updateGarage, title: "Update Garage".tr()),
            ],
          ),
        ),
      ),
