...
class _GaragesMapPageState extends State<GaragesMapPage> {
  ...
  final List<Garage> garages = List.generate(100, (index) {
    final random = Random();
    final cityLatitudes = [11.56, 13.36, 13.10, 10.61, 10.64, 10.99, 13.36, 11.56];
    final cityLongitudes = [104.92, 103.85, 103.20, 104.18, 103.51, 104.78, 103.85, 104.92];
    final cities = ['Phnom Penh', 'Siem Reap', 'Battambang', 'Kampot', 'Sihanoukville', 'Takeo', 'Siem Reap Riverside', 'Wat Phnom'];
  ...
  Future<void> _getCurrentLocation() async {
    ...
    _mapController?.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: currentLatLng, zoom: 14)));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          GoogleMap(
            initialCameraPosition: CameraPosition(target: _currentCenter, zoom: _currentZoom),
